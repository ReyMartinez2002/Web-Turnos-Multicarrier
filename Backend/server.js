...
// 29. LIBERAR TURNO (Quitar empleado sin borrar el turno)
app.patch('/turnos-externos/:id/liberar', (req, res) => {
    const { id } = req.params;
    // Ponemos empleado_id en NULL y cambiamos estado a 'Pendiente'
    const sql = "UPDATE turnos_externos SET empleado_id = NULL, estado_turno = 'PENDIENTE' WHERE id = ?";
